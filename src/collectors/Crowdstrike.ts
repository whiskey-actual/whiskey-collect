  ...
  public async persist() {
    ...
    try {
      ...
      for(let i=0; i<this.CrowdstrikeObjects.length; i++) {
        ...
        // strings
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeCID", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeCID))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeAgentVersion", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeAgentVersion))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeBIOSManufacturer", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeBIOSManufacturer))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeBIOSVersion", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeBIOSVersion))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeExternalIP", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeExternalIP))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeMACAddress", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeMACAddress))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeLocalIP", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeLocalIP))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeMachineDomain", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeMachineDomain))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeMajorVersion", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeMajorVersion))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeMinorVersion", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeMinorVersion))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeOSBuild", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeOSBuild))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeOSVersion", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeOSVersion))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikePlatformName", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikePlatformName))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeReducedFunctionalityMode", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeReducedFunctionalityMode))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeProductTypeDesc", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeProductTypeDesc))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeProvisionStatus", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeProvisionStatus))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeSerialNumber", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeSerialNumber))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeServicePackMajor", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeServicePackMajor))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeServicePackMinor", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeServicePackMinor))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeStatus", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeStatus))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeSystemManufacturer", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeSystemManufacturer))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeSystemProductName", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeSystemProductName))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeKernelVersion", mssql.VarChar(255), this.CrowdstrikeObjects[i].crowdstrikeKernelVersion))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeFirstSeenDateTime", mssql.DateTime2, this.CrowdstrikeObjects[i].crowdstrikeFirstSeenDateTime))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeLastSeenDateTime", mssql.DateTime2, this.CrowdstrikeObjects[i].crowdstrikeLastSeenDateTime))
        ruCrowdstrike.ColumnUpdates.push(new ColumnUpdate("DeviceCrowdstrikeModifiedDateTime", mssql.DateTime2, this.CrowdstrikeObjects[i].crowdstrikeModifiedDateTime))
